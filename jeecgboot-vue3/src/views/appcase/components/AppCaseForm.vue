      ...
      <template #detail>
        <a-form ref="formRef" class="antd-modal-form" :labelCol="labelCol" :wrapperCol="wrapperCol" name="AppCaseForm">
          <a-row>
						...
						<a-col :span="24">
							<a-form-item label="图片[数组]" v-bind="validateInfos.pic" id="AppCaseForm-pic" name="pic">
								<j-image-upload :fileMax="0" v-model:value="formData.pic" ></j-image-upload>
							</a-form-item>
						</a-col>
						<a-col :span="24">
							<a-form-item label="案例内容" v-bind="validateInfos.content" id="AppCaseForm-content" name="content">
...
<script lang="ts" setup>
  ...
  import { saveOrUpdate } from '../AppCase.api';
