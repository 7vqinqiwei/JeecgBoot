  ...
  <div class="p-2">
    ...
    <BasicTable @register="registerTable" :rowSelection="rowSelection">
      ...
      <template #tableTitle>
        ...
        <j-upload-button  type="primary" v-auth="'appbanner:app_banner:importExcel'"  preIcon="ant-design:import-outlined" @click="onImportXls">导入</j-upload-button>
        <a-dropdown v-if="selectedRowKeys.length > 0">
          ...
          <a-button v-auth="'appbanner:app_banner:deleteBatch'">批量操作
    ...
    <!-- 表单区域 -->
    <AppBannerModal ref="registerModal" @success="handleSuccess"></AppBannerModal>
  </div>
</template>
...
<script lang="ts" name="appbanner-appBanner" setup>
  ...
  import { columns, superQuerySchema } from './AppBanner.data';
